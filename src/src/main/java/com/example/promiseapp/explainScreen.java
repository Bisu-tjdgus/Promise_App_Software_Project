...
public class explainScreen extends AppCompatActivity {
    ...
    private TextView explainkorname, explaincolor, explainmedication, explainusage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        explainusage = (TextView)findViewById(R.id.explainusage);
